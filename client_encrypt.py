...
def encrypt():
    ...
    module_b64 = base64.b64encode(json.dumps(payload).encode()).decode()
    output.delete("1.0", tk.END)
    output.insert(tk.END, module_b64)

root = tk.Tk()
root.title("Encrypt & Create Secure Module")
...
tk.Button(root, text="Generate Secure Module", command=encrypt).pack()
